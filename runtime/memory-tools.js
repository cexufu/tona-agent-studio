...
const memoryTools = [
  {
    ...
    policy: { operationRisk: "write", sideEffectScope: "workspace", confirmation: "before_execute", network: "deny", timeoutMs: 5000, retries: 0, idempotent: true, rateLimit: { maxCalls: 60, windowMs: 60000 } },
  ...
  },
  {
    ...
    policy: { operationRisk: "read", sideEffectScope: "none", network: "deny", timeoutMs: 5000, retries: 0, idempotent: false, rateLimit: { maxCalls: 120, windowMs: 60000 } },
  ...
  },
  {
    ...
    policy: { operationRisk: "destructive", sideEffectScope: "workspace", confirmation: "before_execute", network: "deny", timeoutMs: 5000, retries: 0, idempotent: true, rateLimit: { maxCalls: 30, windowMs: 60000 } },
